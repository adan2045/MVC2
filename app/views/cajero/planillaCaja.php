...
.fecha-selector {
    ...
    margin-bottom: 12px;  /* Menos espacio abajo */
...
.planilla-botones-derecha {
    ...
    min-width: 170px;
    max-width: 200px;
    margin-left: 6px;    /* Para que no sobresalga */
    margin-top: 2rem;
}
.planilla-botones-derecha button, .planilla-botones-derecha a button {
    background: black;
    color: white;
    padding: 0.9rem 0;
    border: none;
...
.planilla-botones-derecha button:hover, .planilla-botones-derecha a button:hover {
    background: #222;
}
...
.planilla-resumen {
    margin-top: 1.2rem; /* Menos margen arriba */
}
.planilla-resumen h4 {
...
<body>
    ...
    <script>
        ...
        function abrirCaja() {
            // Aquí puedes agregar la funcionalidad para abrir caja
            if (confirm('¿Desea abrir la caja?')) {
                window.location.href = '<?= $ruta ?>/cajero/abrirCaja';
            }
        }
